...
async function loadSettings() {
    try {
        ...
        document.getElementById('alert_on_security').checked = settings.alert_on_security !== 'false';
...
async function saveSettings() {
    const settings = {
        ...
        alert_on_security: document.getElementById('alert_on_security').checked.toString(),
